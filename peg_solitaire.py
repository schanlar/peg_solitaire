...
def display_board(board_values):
    ...
    print('  1 2 3 4 5 6 7')
    print('A     {} {} {}    '.format(board_values[2], board_values[3], board_values[4]))
    print('B     {} {} {}    '.format(board_values[9], board_values[10], board_values[11]))
    print('C {} {} {} {} {} {} {}'.format(board_values[14], board_values[15], board_values[16], board_values[17],
                                           board_values[18], board_values[19], board_values[20])
                                           )
    print('D {} {} {} {} {} {} {}'.format(board_values[21], board_values[22], board_values[23], board_values[24],
                                           board_values[25], board_values[26], board_values[27])
                                           )
    print('E {} {} {} {} {} {} {}'.format(board_values[28], board_values[29], board_values[30], board_values[31],
                                           board_values[32], board_values[33], board_values[34])
                                           )
    print('F     {} {} {}    '.format(board_values[37], board_values[38], board_values[39]))
    print('G     {} {} {}    '.format(board_values[44], board_values[45], board_values[46]))
...
def remaining_moves(board_coordinates, board_values, show_help=True):
    ...
    for coordinate in board_coordinates:
        if check_move_up(coordinate, board_coordinates=board_coordinates, board_values=board_values, verbatim=False):
            can_move_up = True
            up_counter += 1

        if check_move_down(coordinate, board_coordinates=board_coordinates, board_values=board_values, verbatim=False):
            can_move_down = True
            down_counter += 1

        if check_move_right(coordinate, board_coordinates=board_coordinates, board_values=board_values, verbatim=False):
            can_move_right = True
            right_counter += 1

        if check_move_left(coordinate, board_coordinates=board_coordinates, board_values=board_values, verbatim=False):
            can_move_left = True
            left_counter += 1
...
def main():
    ...
    while remaining_moves(board_coordinates=yx_coordinates, board_values=yx_values):
        user_move = input('Enter peg position followed by move (L, R, U, or D): ').upper()
        ...
        while not ok_to_move:
            ...
            if user_move.endswith('U'): # This can also be written as direction == 'U'
                ok_to_move = check_move_up(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                if ok_to_move:
                    # Update the board values after the movement
                    yx_values = move_up(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                    display_board(yx_values)
                else:
                    user_move = input('Enter peg position followed by move (L, R, U, or D): ').upper()
                    start_from_coordinate = user_move[0] + user_move[1]
            ...
            elif user_move.endswith('D'): # This can also be written as direction == 'D'
                ok_to_move = check_move_down(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                if ok_to_move:
                    # Update the board values after the movement
                    yx_values = move_down(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                    display_board(yx_values)
                else:
                    user_move = input('Enter peg position followed by move (L, R, U, or D): ').upper()
                    start_from_coordinate = user_move[0] + user_move[1]
            ...
            elif user_move.endswith('R'): # This can also be written as direction == 'R'
                ok_to_move = check_move_right(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                if ok_to_move:
                    # Update the board values after the movement
                    yx_values = move_right(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                    display_board(yx_values)
                else:
                    user_move = input('Enter peg position followed by move (L, R, U, or D): ').upper()
                    start_from_coordinate = user_move[0] + user_move[1]
            ...
            elif user_move.endswith('L'): # This can also be written as direction == 'L'
                ok_to_move = check_move_left(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                if ok_to_move:
                    # Update the board values after the movement
                    yx_values = move_left(start_from_coordinate, board_coordinates=yx_coordinates, board_values=yx_values)
                    display_board(yx_values)
                else:
                    user_move = input('Enter peg position followed by move (L, R, U, or D): ').upper()
                    start_from_coordinate = user_move[0] + user_move[1]
